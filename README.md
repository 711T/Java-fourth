...
```
 ...
 ```
  ...
  ```
  + 添加test方法，学号为1001或1002，则输出传入的值，若为其他，则抛出异常，学号必须是1001或者1002
  ```
 ...
 ```
 + 输入第一个博士生的性别，年龄，学费，薪水，输入学号不是1001或者1002，则为异常,转到catch
 ```
...
请输入第一个博士的学号:
1003
java.lang.Exception: 学号必须是1001或者1002。
----------------------------------------------------
请输入第二个博士的名字:
	at Project.Doctor.test(Doctor.java:70)
	at Project.Test.main(Test.java:34)
...
1001
学号是:1001
姓名:张三 性别:男 年龄:26 每学期学费:6000 每月薪水:8000应缴纳纳税额为:100800.0 元
----------------------------------------------------
请输入第二个博士的名字:
  ```
  ## 6.实验感想
